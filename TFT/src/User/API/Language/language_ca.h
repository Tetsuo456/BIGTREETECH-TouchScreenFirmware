...
#define _LANGUAGE_CA_H_
    ...
    #define STRING_DISABLE_STEPPERS       "Desactivar motors"
    ...
    #define STRING_TOUCH_SOUND            "So Tàctil"
    #define STRING_TOAST_SOUND            "So Notificacions"
    #define STRING_ALERT_SOUND            "Popups i Alertes"
    ...
    #define STRING_LEVELING               "Nivellar"
    ...
    #define STRING_BED_LEVELING           "Nivellar llit"
    ...
    #define STRING_BL_ENABLE              "BL: Activat"
    #define STRING_BL_DISABLE             "BL: Desactivat"
    #define STRING_ABL                    "ABL"
    #define STRING_BBL                    "BBL"
    #define STRING_UBL                    "UBL"
    #define STRING_MBL                    "MBL"
    #define STRING_MBL_SETTINGS           "Nivellat Mallat"
    #define STRING_ABL_SETTINGS           "Nivellat Automàtic"
    #define STRING_ABL_SETTINGS_BBL       "Nivellat del llit Bilinear"
    #define STRING_ABL_SETTINGS_UBL       "Nivellat de llit unificat"
    ...
    #define STRING_INVALID_VALUE          "Valor(s) incorrecte(s)"
    #define STRING_TIMEOUT_REACHED        "Temps màxim assolit!"
    #define STRING_PROCESS_RUNNING        "Procès ja executant-se!"
    #define STRING_PROCESS_COMPLETED      "Procès completat!"
    #define STRING_PROCESS_ABORTED        "Procès cancel·lat!"
    #define STRING_INC                    "Augmentar"
    #define STRING_DEC                    "Disminur"
    #define STRING_NOZZLE                 "Broquet"
    ...
    #define STRING_LOAD_UNLOAD            "Carregar/Descarregar"
    #define STRING_  LOAD_UNLOAD_SHORT    "(Des)Carregar"
    ...
    #define STRING_UNCONNECTED            "No hi ha comunicació amb la impressora!"
    ...
    #define STRING_KNOB_LED               "Commutador rotatiu LED"
    #define STRING_KNOB_LED_IDLE          "Commutador rotatiu LED inactiu"
    ...
    #define STRING_MAXFEEDRATE            "Max Vel Alimentació"
    ...
    #define STRING_JUNCTION_DEVIATION     "Desviació de la Junció"
    ...
    #define STRING_SETTING_SAVE           "Gravar configuració"
